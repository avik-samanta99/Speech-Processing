...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	fopen_s(&outPtr, "C:\\Users\\hp\\Desktop\\Speech Processing - PKD\\Cool Edit\\Out_sliding.txt", "a");
	...
	long long groups = 4 * values.size() / chunk - 3;
	long long j, sum;
	for(long long i = 0; i < groups; i ++){
		sum = 0;
		long long start = i * jump, end = start + chunk;
